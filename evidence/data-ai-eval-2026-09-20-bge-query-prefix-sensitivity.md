...
Generated 2026-09-20T08:56:46Z by `analytics/evaluate.py` (script sha256 `44d1a047527a`, git `de082b2ac1`).
...
- Model `BAAI/bge-small-en-v1.5` revision `5c38ec7c405ec4b44b94cc5a9bb96e735b38267a`, 384 dimensions, default max_seq_length 512; requirement prefix: 'Represent this sentence for searching relevant passages: '; wall time 35.2s.
...
| Method | bge-small-en-v1.5: P@5 strict / lenient / NDCG@5 |
|---|---|
| Requirement-level (contract method) | 0.560 / 0.640 / 0.866 |
| Baseline A: keyword / BM25 | 0.560 / 0.640 / 0.871 |
| Baseline B: pooled-chunk embedding | 0.520 / 0.680 / 0.877 |
| Baseline B2: whole-resume vector (TRUNCATES) | 0.520 / 0.680 / 0.879 |
...
|---|---|---|---|---|---|
| P01 | 4 | 0.600 / 0.794 | 0.600 / 0.839 | 0.600 / 0.839 | 0.600 / 0.839 |
| P02 | 4 | 0.600 / 0.924 | 0.600 / 0.915 | 0.600 / 0.924 | 0.600 / 0.915 |
| P03 | 4 | 0.600 / 0.908 | 0.600 / 0.908 | 0.600 / 0.908 | 0.600 / 0.908 |
| P04 | 4 | 0.600 / 0.924 | 0.600 / 0.915 | 0.400 / 0.741 | 0.400 / 0.741 |
| P05 | 4 | 0.400 / 0.778 | 0.400 / 0.778 | 0.400 / 0.973 | 0.400 / 0.990 |

Top-5 ranked jobs as `job(label)`:

- P01 Requirement-level (contract method): J02(2) J07(2) J29(0) J03(0) J01(2)
...
- P02 Requirement-level (contract method): J06(2) J11(2) J10(2) J07(1) J17(0)
...
- P03 Requirement-level (contract method): J08(2) J09(2) J11(2) J29(0) J27(0)
...
- P04 Requirement-level (contract method): J20(2) J21(2) J03(2) J27(1) J23(0)
...
- P05 Requirement-level (contract method): J12(2) J28(2) J24(0) J14(0) J03(0)
...
| Method | bge-small-en-v1.5: P@5 strict / lenient / NDCG@5 |
|---|---|
| Requirement-level (contract method) | 0.600 / 0.640 / 0.869 |
| Baseline A: keyword / BM25 | 0.640 / 0.720 / 0.910 |
| Baseline B: pooled-chunk embedding | 0.520 / 0.680 / 0.798 |
| Baseline B2: whole-resume vector (TRUNCATES) | 0.600 / 0.680 / 0.826 |
...
| Profile | Chunks | Requirement-level (contract method) | Baseline A | Baseline B | Baseline B2 |
|---|---|---|---|---|---|
| P06 | 4 | 0.600 / 0.812 | 0.600 / 0.924 | 0.600 / 0.924 | 0.600 / 0.893 |
...
| P10 | 10 | 0.800 / 0.854 | 1.000 / 1.000 | 0.600 / 0.788 | 1.000 / 1.000 |

Top-5 ranked jobs as `job(label)`:

- P06 Requirement-level (contract method): J04(2) J03(2) J02(0) J01(2) J10(0)
...
- P07 Requirement-level (contract method): J07(2) J06(2) J10(2) J11(0) J17(0)
...
- P08 Requirement-level (contract method): J13(2) J30(2) J01(1) J07(0) J24(0)
...
- P10 Requirement-level (contract method): J02(2) J05(2) J03(2) J10(0) J01(2)
...
- Mean requirement-level job score per profile (length-bias check against chunk count): P01=0.560, P02=0.566, P03=0.560, P04=0.559, P05=0.547, P06=0.565, P07=0.574, P08=0.568, P09=0.566, P10=0.589.
- Mean requirement_level score by label (development): label 0=0.545 (n=125), label 1=0.582 (n=11), label 2=0.663 (n=14).
- Mean requirement_level score by label (held_out): label 0=0.557 (n=124), label 1=0.593 (n=9), label 2=0.671 (n=17).
