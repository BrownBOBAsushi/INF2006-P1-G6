...
Generated 2026-09-21T18:47:25Z by `analytics/evaluate.py` (script sha256 `44d1a047527a`, git `1006a30087`).

> **Custom label file labels_adjudicated_v1.csv: provenance/review status is not verified by this script.**

Subset(s) evaluated: **development, held_out**. Labels: `labels_adjudicated_v1.csv`. Fixtures: 30 jobs, 10 profiles; sha256 jobs.json `7b32914c674e`, profiles.json `136303808954`, labels_adjudicated_v1.csv `2f3b5928b837`.

- Model `sentence-transformers/all-MiniLM-L6-v2` revision `1110a243fdf4706b3f48f1d95db1a4f5529b4d41`, 384 dimensions, default max_seq_length 256; requirement prefix: ''; wall time 13.7s.
...
| Baseline B: pooled-chunk embedding | 0.520 / 0.640 / 0.869 | 0.520 / 0.680 / 0.908 |
...
5 profiles x 30 jobs. Ceilings: strict P@5 0.720, lenient P@5 0.880, NDCG@5 1.000. Small sample: point estimates only.

| Method | all-MiniLM-L6-v2: P@5 strict / lenient / NDCG@5 | bge-small-en-v1.5: P@5 strict / lenient / NDCG@5 |
|---|---|---|
| Requirement-level (contract method) | 0.680 / 0.760 / 0.919 | 0.680 / 0.720 / 0.912 |
| Baseline A: keyword / BM25 | 0.640 / 0.680 / 0.868 | 0.640 / 0.680 / 0.868 |
| Baseline B: pooled-chunk embedding | 0.560 / 0.640 / 0.751 | 0.560 / 0.640 / 0.772 |
| Baseline B2: whole-resume vector (TRUNCATES) | 0.560 / 0.640 / 0.770 | 0.600 / 0.640 / 0.782 |
...
- Mean requirement_level score by label (development): label 0=0.181 (n=126), label 1=0.288 (n=11), label 2=0.367 (n=13).
- Mean requirement_level score by label (held_out): label 0=0.212 (n=123), label 1=0.276 (n=9), label 2=0.415 (n=18).
- Mean pooled_chunk score by label (development): label 0=0.245 (n=126), label 1=0.357 (n=11), label 2=0.509 (n=13).
- Mean pooled_chunk score by label (held_out): label 0=0.279 (n=123), label 1=0.356 (n=9), label 2=0.509 (n=18).
...
- Mean requirement_level score by label (development): label 0=0.569 (n=126), label 1=0.616 (n=11), label 2=0.677 (n=13).
- Mean requirement_level score by label (held_out): label 0=0.582 (n=123), label 1=0.606 (n=9), label 2=0.681 (n=18).
- Mean pooled_chunk score by label (development): label 0=0.616 (n=126), label 1=0.673 (n=11), label 2=0.741 (n=13).
- Mean pooled_chunk score by label (held_out): label 0=0.641 (n=123), label 1=0.671 (n=9), label 2=0.742 (n=18).
