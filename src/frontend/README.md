...
The resume feature review below records the independent 2026-09-12 fixes and
verification that preceded this application-shell integration. It remains a
historical record; current application commands are documented above.
...
provisional manifest at that time. The declared dependency pins and a clean
installation still needed verification then; no lockfile was fabricated.
